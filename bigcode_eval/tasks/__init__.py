...
from . import (apps, codexglue_code_to_text, codexglue_text_to_text, conala,
               ...
               parity, python_bugs, quixbugs, recode, santacoder_fim, aatk, instruct_codexglue_clone_detection, instruct_codexglue_defect_detection)
...
TASK_REGISTRY = {
    ...
    **aatk.create_all_tasks(),
    "instruction_codexglue_clone_detection": instruct_codexglue_clone_detection.CloneDetection,
    "instruction_codexglue_defect_detection": instruct_codexglue_defect_detection.DefectDetection,
}
